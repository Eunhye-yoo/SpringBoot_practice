...
//    }
//    @Test
//    @DisplayName("미션1- write2의 글 중 조회수 50 이상, title과 viewCnt만 조회")
//    public void mission1(){
//        // selectFrom - -> Entity의 모든 필드 반환 -> List<Board>
//        // select -> Entity의 원하는 필드 반환 -> List<Tuple>
//        List<Tuple> list =
//        qf.select(board.title, board.viewCnt)
//                .from(board)
...
//                    + tuple.get(board.viewCnt.sum()));
//        }
//
//        // writer2가 작성한 글 총 20개, i = 2,6,12, ...52 ~ 97 -> 10건
...
//        // ORDER BY writer ASC;
//        List<Tuple> list =
//        qf.select(board.writer, board.countDistinct(), board.viewCnt.sum())
//                .from(board)
